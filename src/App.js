...
class App extends Component{
  state={
    ...
    words:[// definindo as palavras
      ...
      {word: 'EDIFICAÇOES', discovered: false},
      {word: 'PUTA', discovered: false},
      {word: 'SANDALIO', discovered: false},
      {word: 'VIADO', discovered: false},
      {word: 'EXTERNOCLEIDOMASTOIDEO', discovered: false},
      {word: 'PARALELEPIPEDO', discovered: false},
      {word: 'Paraclorobenzilpirrolidinonetilbenzimidazol'.toLocaleUpperCase(), discovered: false},
      {word: 'Pneumoultramicroscopicossilicovulcanoconiótico'.toLocaleUpperCase(), discovered: false},
      {word: 'Piperidinoetoxicarbometoxibenzofenona '.toLocaleUpperCase(), discovered: false},
      {word: 'Tetrabrometacresolsulfonoftaleína '.toLocaleUpperCase(), discovered: false},
      {word: 'Dimetilaminofenildimetilpirazolona'.toLocaleUpperCase(), discovered: false},
      {word: 'Hipopotomonstrosesquipedaliofobia '.toLocaleUpperCase(), discovered: false},
      {word: 'Monosialotetraesosilgangliosideo'.toLocaleUpperCase(), discovered: false},
      {word: 'Anticonstitucionalissimamente '.toLocaleUpperCase(), discovered: false},
      {word: 'Oftalmotorrinolaringologista '.toLocaleUpperCase(), discovered: false},
      {word: 'Inconstitucionalissimamente '.toLocaleUpperCase(), discovered: false},
